...
대본 자막은 이해하기 쉽게 작성해야 함. 장면마다 `captions` 배열. 한 덩어리로 오래 띄우지 말고 문장 단위로 끊는다. 뉴스 용어는 쉬운 말로. 한 줄이 길면 2줄. 흰 글자 + 어두운 박스/외곽선, 하단 세이프 영역. 숫자·핵심어만 색/굵기. 키네틱 금지. 쇼츠에서 3초 안에 읽히는 호흡. ~입니다/~습니다.
